    ...
    <section className="flexCenter flex-col">
      ...
      <div className=" flexCenter max-container relative w-full border-2 border-blue-500 ">
        <Image
          ...
          width={1440}
          height={580}
          className="w-full object-cover object-center 2xl:rounded-5"
        />
        <div className="absolute flex bg-white py-8 pl-5 pr-7 gap-3 rounded-3xl border shadow-md md:left-[5%] lg:top-20">
          <Image src='/meter.svg' alt="meter" width={15} height={158} className="h-full w-auto"/>
          <div className="flexBetween flex-col ">
            <div className="flex w-full flex-col">
              ...
              <p className="bold-20 mt-2 mb-2 ">Aguas Calientes</p>
            </div>
            <div className="flex w-full flex-col">
              <p className="regular-16 text-gray-500 mt-4">Start track</p>
