...
const Navbar = () => {
  return (
    <nav className="">
      ...
      <ul className=" ml-3 sm:flex-row sm:gap-3 items-center z-50 relative md:hidden w-full">
        <Link
          href="/"
          className="  inline-block sm:flex regular-12  text-gray-50   cursor-pointer pb-1.5 transition-all hover:font-bold"
        >
          home
        </Link>
        <Link
