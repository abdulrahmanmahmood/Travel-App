...
const Navbar = () => {
  return (
    <nav className="">
      ...
      <ul className="  mr-auto items-center z-50 relative md:hidden w-full">
        <Link
          href="/"
          className=" ml-1 inline-block regular-12  text-gray-50   cursor-pointer pb-1.5 transition-all hover:font-bold"
        >
          home
        </Link>
        <Link
