...
<nav classNameName="bg-white border-gray-200 dark:bg-gray-900">
    <div classNameName="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
...
// <nav
//   classNameName=" flexBetween max-container padding-container relative z-30
// py-5"
// >
//   <Link href="/">
...
//   <ul classNameName="flex flex-row flex-wrap gap-5 lg:gap-12">
//     {NAV_LINKS.map((link) => (
//       <Link
//         href={link.href}
//         key={link.key}
