...
const Navbar = () => {
  return (
    <nav className="">
      ...
      <ul className=" ml-3 sm:flex-row sm:gap-4 sm:ml-[110px] items-center z-50 relative md:hidden w-full">
        <Link
          href="/"
        ...
        <Link
          href="/"
          className="mx-3 regular-10 inline-block  text-gray-50  cursor-pointer pb-1.5 transition-all hover:font-bold"
        >
          How Hilink Work?
        </Link>
        <Link
