...
const Navbar = () => {
  return (
    <nav className="">
      ...
      <ul className=" z-50 relative md:hidden  w-full">
        <Link
          href="/"
          className=" block regular-12 justify-center items-center text-gray-50   cursor-pointer pb-1.5 transition-all hover:font-bold"
        >
          home
        </Link>
        <Link
